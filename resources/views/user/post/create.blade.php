    ...
    <div class="row justify-content-center">
        <div class="col-12 col-lg-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form id="post-creation-form" method="POST" action="{{ route('post.store') }}">
                        @csrf
                        ...
                        <div class="form-group mb-4">
                            <textarea id="summernote" name="description" class="@error('description') is-invalid @enderror">{{ old('description') }}</textarea>
